...
articleView.handleAuthorFilter = function() {
  $('#author-filter').on('change', function() {
    ...
    //DANGER: WHats up with template showing at beginning?
    $('#category-filter').val(''); // This will basically reset the drop down menus. If you select from category after an author was selected then it will reset author
